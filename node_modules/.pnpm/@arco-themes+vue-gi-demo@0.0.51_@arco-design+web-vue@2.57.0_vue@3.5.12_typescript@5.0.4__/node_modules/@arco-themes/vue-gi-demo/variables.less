...
@btn-dashed-color-bg_success_active: @color-success-1;
...
@menu-dark-color-item_default: var(~'@{arco-cssvars-prefix}-color-white');
@menu-dark-color-item_hover: var(~'@{arco-cssvars-prefix}-color-white');
@menu-dark-color-item_disabled: var(~'@{arco-cssvars-prefix}-color-text-4');
@menu-dark-color-icon_disabled: var(~'@{arco-cssvars-prefix}-color-text-4');
...
@menu-dark-color-item_selected: @color-link-6;
@menu-dark-color-icon_selected: @color-link-6;
@btn-outline-color-text_hover: var(~'@{arco-cssvars-prefix}-color-white');
@btn-outline-color-text_active: var(~'@{arco-cssvars-prefix}-color-white');
@btn-outline-color-bg: @color-link-1;
@btn-outline-color-bg_hover: @color-link-6;
@btn-outline-color-border: @color-link-3;
@btn-outline-color-text_warning_hover: var(~'@{arco-cssvars-prefix}-color-white');
@btn-outline-color-bg_warning: @color-warning-1;
@btn-outline-color-bg_warning_hover: @color-warning-6;
@btn-outline-color-bg_warning_active: @color-warning-7;
@btn-outline-color-bg_active: @color-link-7;
@btn-outline-color-border_warning: @color-warning-3;
@btn-outline-color-text_warning_active: var(~'@{arco-cssvars-prefix}-color-white');
@btn-outline-color-text_danger_hover: var(~'@{arco-cssvars-prefix}-color-white');
@btn-outline-color-bg_danger_hover: @color-danger-6;
@btn-outline-color-text_danger_active: var(~'@{arco-cssvars-prefix}-color-white');
@btn-outline-color-text_success_hover: var(~'@{arco-cssvars-prefix}-color-white');
@btn-outline-color-bg_success: @color-success-1;
@btn-outline-color-text_success_active: var(~'@{arco-cssvars-prefix}-color-white');
@btn-outline-color-bg_success_hover: @color-success-6;
@btn-outline-color-bg_danger: @color-danger-1;
@btn-outline-color-border_danger: @color-danger-3;
@btn-outline-color-bg_success_active: @color-success-7;
@btn-outline-color-border_success: @color-success-3;
@btn-outline-color-bg_danger_active: @color-danger-7;

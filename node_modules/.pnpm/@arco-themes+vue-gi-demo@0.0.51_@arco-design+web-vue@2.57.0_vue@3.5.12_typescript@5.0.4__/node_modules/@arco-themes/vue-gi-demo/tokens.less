...
@color-preview-size-medium: 24px;
@color-preview-size-large: 26px;
@color-input-size-mini-padding: 4px 4px;
@color-input-size-small-padding: 3px 4px;
@color-input-size-medium-padding: 4px 4px;
@color-input-size-large-padding: 5px 5px;
...
@color-value-size-medium-font-size: 14px;
...
@btn-outline-color-text_hover: var(--color-white);
@btn-outline-color-text_active: var(--color-white);
@btn-outline-color-bg: rgb(var(--link-1));
@btn-outline-color-bg_disabled: transparent;
@btn-outline-color-bg_hover: rgb(var(--link-6));
@btn-outline-color-bg_active: rgb(var(--link-7));
@btn-outline-color-border: rgb(var(--link-3));
...
@btn-outline-color-text_warning_hover: var(--color-white);
@btn-outline-color-text_warning_active: var(--color-white);
@btn-outline-color-bg_warning: rgb(var(--warning-1));
@btn-outline-color-bg_warning_disabled: transparent;
@btn-outline-color-bg_warning_hover: rgb(var(--warning-6));
@btn-outline-color-bg_warning_active: rgb(var(--warning-7));
...
@btn-outline-color-text_danger_hover: var(--color-white);
@btn-outline-color-text_danger_active: var(--color-white);
@btn-outline-color-bg_danger: rgb(var(--danger-1));
@btn-outline-color-bg_danger_disabled: transparent;
@btn-outline-color-bg_danger_hover: rgb(var(--danger-6));
@btn-outline-color-bg_danger_active: rgb(var(--danger-7));
...
@btn-outline-color-text_success_hover: var(--color-white);
@btn-outline-color-text_success_active: var(--color-white);
@btn-outline-color-bg_success: rgb(var(--success-1));
@btn-outline-color-bg_success_disabled: transparent;
@btn-outline-color-bg_success_hover: rgb(var(--success-6));
@btn-outline-color-bg_success_active: rgb(var(--success-7));
...
@btn-dashed-color-bg_success_active: rgb(var(--success-1));
...
@menu-dark-color-item_default: var(--color-white);
@menu-dark-color-item_hover: var(--color-white);
@menu-dark-color-item_selected: rgb(var(--link-6));
...
@menu-dark-color-icon_selected: rgb(var(--link-6));

import {
  isVue2
} from "./chunk-ZWCFG4EX.js";
import {
  autocompletion,
  closeBrackets,
  closeBracketsKeymap,
  completionKeymap
} from "./chunk-UK7NT2KF.js";
import {
  Annotation,
  ChangeDesc,
  ChangeSet,
...
// node_modules/.pnpm/@codemirror+commands@6.5.0/node_modules/@codemirror/commands/dist/index.js
...
// node_modules/.pnpm/@codemirror+lint@6.7.1/node_modules/@codemirror/lint/dist/index.js
...
// node_modules/.pnpm/vue-codemirror6@1.3.0_@lezer+common@1.2.1_vue@3.5.12_typescript@5.0.4_/node_modules/vue-codemirror6/dist/index.es.js
var le = {
  version: "1.3.0",
  date: "2024-04-24T08:18:55.338Z"
};
var ge = le;
var ie = (e) => e ? Object.entries(e).reduce((i, [l, u]) => (l = l.charAt(0).toUpperCase() + l.slice(1), l = `on${l}`, { ...i, [l]: u }), {}) : {};
function B(e, i = {}, l) {
  if (isVue2)
    return h(e, i, l);
  const { props: u, domProps: t, on: d, ...f } = i, m = d ? ie(d) : {};
  return h(
    e,
    { ...f, ...u, ...t, ...m },
    l
...
var se = defineComponent({
  ...
  setup(e, i) {
    ...
    ), S = ref(0), g = ref(0), h2 = computed(() => {
      const a = new Compartment(), n = new Compartment();
      return [
        // Toggle basic setup
        e.basic ? basicSetup : void 0,
        // Toggle minimal setup
        e.minimal && !e.basic ? minimalSetup : void 0,
        // ViewUpdate event listener
        EditorView.updateListener.of((o) => {
          var _a;
          i.emit("focus", t.value.hasFocus), S.value = (_a = t.value.state.doc) == null ? void 0 : _a.length, !(o.changes.empty || !o.docChanged) && (e.linter && (e.forceLinting && forceLinting(t.value), g.value = e.linter(t.value).length), i.emit("update", o));
        }),
    ...
    watch(
      ...
      (a) => {
        ...
        (_a = t.value) == null ? void 0 : _a.dispatch({
          effects: StateEffect.reconfigure.of(a)
        });
      },
      { immediate: true }
    ), watch(
...
`) === a || t.value.dispatch({
      ...
      l.value && (l.value.childNodes[0] && (u.value !== "" && console.warn(
        ...
        parent: l.value,
        state: EditorState.create({ doc: a, extensions: h2.value }),
        dispatch: (n) => {
    ...
    const V = () => {
      !e.linter || !t.value || (e.forceLinting && forceLinting(t.value), g.value = diagnosticCount(t.value.state));
    }, j = () => {
      var _a, _b;
      (_a = t.value) == null ? void 0 : _a.dispatch({
        effects: StateEffect.reconfigure.of([])
      }), (_b = t.value) == null ? void 0 : _b.dispatch({
        effects: StateEffect.appendConfig.of(h2.value)
      });
    ...
    }, D = () => t.value.state.selection.ranges.some(
      (a) => !a.empty
    ), E = (a, n, o) => t.value.dispatch({
      changes: { from: n, to: o, insert: a }
    }), R = (a) => t.value.dispatch(t.value.state.replaceSelection(a)), F = (a) => t.value.dispatch({ selection: { anchor: a } }), J = (a, n) => t.value.dispatch({ selection: { anchor: a, head: n } }), A = (a, n) => t.value.dispatch({
...
var he = (e) => e.component("CodeMirror", se);
export {
  ge as Meta,
  se as default,
  he as install
